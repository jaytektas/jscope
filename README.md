...
**Linux (Debian/Ubuntu)** — download `jscope_0.1.2_amd64.deb` from
[Releases](https://github.com/jaytektas/jscope/releases):

```sh
sudo apt install ./jscope_0.1.2_amd64.deb
```
...
**Windows** — download `jscope-0.1.2-win64.zip` from the same place, unzip, run
